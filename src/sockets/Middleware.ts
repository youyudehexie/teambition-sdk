...
import { clone, forEach, WSMsgResult } from '../utils'
...
export type MsgHandler = (msg: WSMsgResult) => void
...
export type Interceptor = (msg: WSMsgResult, ...args: any[]) => void | ControlFlow
